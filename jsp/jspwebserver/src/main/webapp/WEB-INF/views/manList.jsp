        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div role="tabpanel"> 
	          ...
	          <ul class="nav nav-tabs" role="tablist">
			    ...
			    <li role="presentation"><a href="#beverage" id="deverage-tab" aria-controls="beverage" role="tab" data-toggle="tab" class="custom-tab">음료</a></li>
                        	...
                        	<div class="row" id ="data">
                        		<div class="btn-group col-xs-12" data-toggle="buttons">
								  <label class="btn btn-default active col-xs-4">
								    <input type="radio" name="radioOptions" id="radioOption1" autocomplete="off" value="H" checked> HOT
								  </label>
