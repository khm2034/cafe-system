         ...
         <div role="tabpanel" id="tabs"> 
          ...
          <div class = "tab-content">
            ...
            <div role="tabpanel" class="tab-pane fade active" id="menu" aria-labelledby="menu-tab">
              <div role="tabpanel" id="tabs">
		          <ul class="nav nav-tabs" role="tablist">
		            <li role="presentation" class="active"><a href="#coffee" id="coffee-tab" aria-controls="coffee" role="tab" data-toggle="tab" class="custom-tab">커피</a></li>
		            <li role="presentation"><a href="#beverage" id="beverage-tab" aria-controls="beverage" role="tab" data-toggle="tab" class="custom-tab">음료</a></li>
		            <li role="presentation"><a href="#dessert" id="dessert-tab" aria-controls="dessert" role="tab" data-toggle="tab" class="custom-tab">디저트</a></li>
		          </ul>
		      
		          <div class = "tab-content">
		            <div role="tabpanel" class="tab-pane fade in active" id="coffee" aria-labelledby="coffee-tab">
		               <div id="coffeePlot" style="width: 90%; height:400px;"></div> 
		            </div>
		
		            <div role="tabpanel" class="tab-pane fade active" id="beverage" aria-labelledby="beverage-tab">
		               <div id="beveragePlot" style="width: 90%; height:400px;"></div>
		            </div>
		            
		            <div role="tabpanel" class="tab-pane fade active" id="dessert" aria-labelledby="dessert-tab">
		               <div id="dessertPlot" style="width: 90%; height:400px;"></div>
		            </div>                      
		          </div>
		        </div> 
            </div>
...
// sortArr(male);
      ...
      $(document).ready(function(){
    	  ...
    	  <c:forEach var="row" items="${coffeeMap}">
    	  	var tmp = [];
    	  	tmp.push('${row.key}');
    	  	tmp.push(parseInt('${row.value}'));
    	  	coffee.push(tmp);
		  ...
		  <c:forEach var="row" items="${beverageMap}">
	  	  	var tmp = [];
	  	  	tmp.push('${row.key}');
	  	  	tmp.push(parseInt('${row.value}'));
	  	  beverage.push(tmp);
		 ...
		 // sortArr(beverage);
		  ...
		  <c:forEach var="row" items="${dessertMap}">
	  	  	var tmp = [];
	  	  	tmp.push('${row.key}');
	  	  	tmp.push(parseInt('${row.value}'));
	  	  dessert.push(tmp);
		 ...
		 // sortArr(dessert);
    	  ...
    	  menuPlot1 = $.jqplot('coffeePlot', [coffee], {
	  	        gridPadding: {top:0, bottom:38, left:0, right:0},
	  	        seriesDefaults:{
	  	            renderer:$.jqplot.PieRenderer, 
	  	            trendline:{ show:false }, 
	      ...
	      menuPlot2 = $.jqplot('beveragePlot', [beverage], {
		        gridPadding: {top:0, bottom:38, left:0, right:0},
		        seriesDefaults:{
		            renderer:$.jqplot.PieRenderer, 
		            trendline:{ show:false }, 
	      ...
	      menuPlot3 = $.jqplot('dessertPlot', [dessert], {
		        gridPadding: {top:0, bottom:38, left:0, right:0},
		        seriesDefaults:{
		            renderer:$.jqplot.PieRenderer, 
		            trendline:{ show:false }, 
      ...
      $(document).ready(function(){
    	  ...
    	  $('a[href="#coffee"]').tab('show');
    	  $('a[href="#beverage"]').tab('show');
    	  $('a[href="#dessert"]').tab('show');
    	  $('a[href="#coffee"]').tab('show');
